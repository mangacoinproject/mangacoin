...
Mangacoin Core now supports P2SH addresses beginning with P on mainnet and p on testnet.
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/mangacoinproject/mangacoin/blob/master-0.14/src/chainparams.cpp#L220).
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/mangacoinproject/mangacoin/blob/master-0.14/doc/zmq.md) for
