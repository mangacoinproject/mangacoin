...
"""Verify that starting mangacoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mangacoin with -h for help text")
        ...
        self.log.info("Start mangacoin with -version for version information")
