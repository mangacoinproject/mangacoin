...
Run this script from the directory containing the mangacoin, gitian-builder, gitian.sigs.ltc, and mangacoin-detached-sigs.
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.ltc/ ../mangacoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ltc/ ../mangacoin/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.ltc/ ../mangacoin/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	echo ""
	./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-linux ../mangacoin/contrib/gitian-descriptors/gitian-linux.yml
	# Windows
	echo ""
	echo "Verifying v${VERSION} Windows"
	echo ""
	./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-unsigned ../mangacoin/contrib/gitian-descriptors/gitian-win.yml
	# Mac OSX	
	echo ""
	echo "Verifying v${VERSION} Mac OSX"
	echo ""	
	./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-osx-unsigned ../mangacoin/contrib/gitian-descriptors/gitian-osx.yml
	# Signed Windows
	echo ""
	echo "Verifying v${VERSION} Signed Windows"
	echo ""
	./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-osx-signed ../mangacoin/contrib/gitian-descriptors/gitian-osx-signer.yml
	# Signed Mac OSX
	echo ""
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../mangacoin/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.ltc/ ../mangacoin/contrib/gitian-descriptors/gitian-osx-signer.yml
